...
public class AccessKeyUtil {
    ...
    */
     ...
     *                                field is inaccessible.
     */
    public String createTokenWithBean(TimeSpan expire, String subject, String audience, Object bean) throws IllegalAccessException {
        return createTokenWithBean(expire, subject, new String[]{audience}, bean);
    }
